  ...
  return (
    <main style={{ margin: '-15px' }}>
      ...
      >
        ...
        <img src="https://i.imgur.com/bVwCc7y.png" style={{ width: '100%' }} />
        <img src="https://i.imgur.com/l03QIba.png" style={{ width: '100%' }} />
        <img src="https://i.imgur.com/ZkQ6Dmp.png" style={{ width: '100%' }} />
        <img src="https://i.imgur.com/Y6DGppn.png" style={{ width: '100%' }} />
      ...
      <div style={{ position: 'fixed', bottom: '70px', padding: '20px', paddingRight: '30px', zIndex: 99999 }}>
        <h2 style={{ margin: '0 0 10px 0' }}>불편한 KLAS를<br />더 편리하게.</h2>
